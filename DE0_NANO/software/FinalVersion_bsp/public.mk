...
# setting SOPC_SYSID_BASE_ADDRESS is 0x40084a8
SOPC_SYSID_FLAG += --sidp=0x40084a8
ELF_PATCH_FLAG  += --sidp 0x40084a8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1461144775
SOPC_SYSID_FLAG += --timestamp=1461144775
ELF_PATCH_FLAG  += --timestamp 1461144775
