...
HTTP_IO_RESULT HTTPExecuteGet(void)
{
    ...
    else if(!memcmppgm2ram(filename, "odo.htm", 7))
	{
        ...
        ptr = HTTPGetROMArg(curHTTP.data, (ROM BYTE *)"var7");
		if(ptr){
            if(*ptr != '\0'){
                var7 = atof(ptr);
            }
        }
        ptr = HTTPGetROMArg(curHTTP.data, (ROM BYTE *)"var8");
		if(ptr){
            if(*ptr != '\0'){
                var8 = atof(ptr);
            }
        ...
        ptr = HTTPGetROMArg(curHTTP.data, (ROM BYTE *)"var10");
		if(ptr){
            if(*ptr != '\0'){
                var10 = atof(ptr);
            }
        }
        ptr = HTTPGetROMArg(curHTTP.data, (ROM BYTE *)"var11");
		if(ptr){
            if(*ptr != '\0'){
                var11 = atof(ptr);
            }
        }
        ptr = HTTPGetROMArg(curHTTP.data, (ROM BYTE *)"var12");
		if(ptr){
            if(*ptr != '\0'){
                var12 = atof(ptr);
            }
        }
        ptr = HTTPGetROMArg(curHTTP.data, (ROM BYTE *)"var13");
		if(ptr){
            if(*ptr != '\0'){
                var13 = atof(ptr);
            }
    ...
    else if(!memcmppgm2ram(filename, "thetaAligned.htm", 16))
	{
        ...
        ptr = HTTPGetROMArg(curHTTP.data, (ROM BYTE *)"var16");
		if(ptr){
            if(*ptr != '\0'){
                var16 = atof(ptr);
            }
        }
        ptr = HTTPGetROMArg(curHTTP.data, (ROM BYTE *)"var17");
		if(ptr){
            if(*ptr != '\0'){
                var17 = atof(ptr);
            }
    ...
    else if(!memcmppgm2ram(filename, "pathplanning.htm", 16))
	{
        ...
        ptr = HTTPGetROMArg(curHTTP.data, (ROM BYTE *)"var20");
		if(ptr){
            if(*ptr != '\0'){
                var20 = atof(ptr);
            }
        }
        ptr = HTTPGetROMArg(curHTTP.data, (ROM BYTE *)"var21");
		if(ptr){
            if(*ptr != '\0'){
                var21 = atof(ptr);
            }
	...
	{       
        ...
        ptr = HTTPGetROMArg(curHTTP.data, (ROM BYTE *)"var23");
		if(ptr){
            if(*ptr != '\0'){
                var23 = atof(ptr);
            }
